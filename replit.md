...
2. ✅ إزالة متطلب 6 فيديوهات للـ Desktop Apps
3. ✅ تحديث نظام الفيديوهات:
   - فيديو واحد فقط (اختياري) للعرض في كارت المشروع
   - الفيديوهات الإضافية للبرامج تُرسل بعد الشراء
4. ✅ إصلاح API لرفع المشاريع
5. ✅ تحديث واجهة VideoLinksUploader
6. ✅ إصلاح رفع صورة الملف الشخصي في صفحة التسجيل:
