...
### ✅ نظام المصادقة والبروفايل
- **AuthContext**: نظام متكامل لإدارة حالة المستخدم
- **Navbar الذكي**: يعرض صورة البروفايل عند تسجيل الدخول، وأزرار التسجيل/الدخول عند عدم التسجيل
